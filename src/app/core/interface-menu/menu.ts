  ...
  public static pages: MenuItem[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: 'Cuentas',
          route: '/components/cuentas-table',
        },
        {
          icon:
            'data:image/svg+xml;base64,' +
        ...
        },
        {
          ...
          label: 'Personal',
          route: '/components',
          children: [{ label: 'Vendedores', route: '/components/table' }],
        },
        {
          icon:
            'data:image/svg+xml;base64,' +
          ...
          label: 'Clientes',
          route: '/components/clientes-table',
          children: [
            { label: 'Clientes potenciales', route: '/components/clientes-potenciales' },
        ...
        },
        {
          ...
          label: 'Auth',
          route: '/auth',
          children: [{ label: 'New Password', route: '/auth/new-password' }],
        },
      ],
    },
    {
